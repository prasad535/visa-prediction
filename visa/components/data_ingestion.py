...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        Descripton  : This method exports data from mongodb to csv file
        ...
        try:
            ...
            logging.info(f"Savinf exported data into feature store file path: {feature_store_file_path}")
            dataframe.to_csv(feature_store_file_path, index=False, header=True)
            logging.info("Completed export_data_into_feature_store method of Data_Ingestion class")
            return dataframe
        except Exception as e:
            logging.info(VisaException(e, sys))
            raise VisaException(e, sys)
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("{erfpr,ed train test split  on the dataset")
